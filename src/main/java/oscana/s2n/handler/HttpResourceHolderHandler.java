 ...
 */
public class HttpResourceHolderHandler implements Handler<HttpRequest, Object> {

    public HttpResourceHolderHandler() {
        super();
    }
     ...
     * ハンドラーで処理する。<br>
     * <br>
     * ・HttpResourceHolderにサーブレットリソースへの参照を登録し、次のhandleの処理を行う。<br>
     * ・handleから戻ってきたところでサーブレットリソースへの参照を削除する。<br>
     *
     * @return 結果データ
     */
    @Override
    public Object handle(final HttpRequest request, final ExecutionContext context) {
        ...
        try {
            ...
            //Http系リソースへの参照をHttpResourceHolderに登録する
