...
public class EmailTest {
    ...
    public void testIsNotValid() {
        ...
        assertThat(v.getMessage(), is("{fieldName}はメールとして不正です。"));
    }
